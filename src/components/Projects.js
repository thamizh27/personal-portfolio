...
const Projects = () => {
  ...
  return (
    <div className="mt-20 w-4/5 mx-auto grid grid-cols-1 gap-16">
      {/* card - 1 */}
      <h1 className="text-4xl mt-8 font-semibold uppercase text-center">
        Projects
      </h1>
      <section className="w-full h-full m-auto  border-2 border-gray-100">
        <div className="flex items-center justify-evenly">
          <img
            src={portfolio}
            alt="web screenshot"
            className="max-h-80 border border-gray-100 rounded-xl shadow-lg mt-10 mb-10"
          />
          <div>
            ...
            <ul className="">
              ...
              <li className="ml-4 mt-5">&#9733; Tailwind css</li>
              <ul>
                <li className="ml-10">Utility classes</li>
              </ul>
              <li className="ml-4 mt-5">&#9733; AOS - Animation on scroll</li>
            </ul>
            <div className="mt-4 text-blue-800 font-bold text-center">
              <a
                rel="noreferrer"
                target="_blank"
                href="https://github.com/thamizh27/personal-portfolio.git"
                className="border-b-2 border-white text-2xl hover:border-blue-800 capitalize"
              >
                Source code
              </a>
            </div>
      ...
      <section className="w-full h-full m-auto border-2 border-gray-100">
        <div className="flex items-center justify-evenly">
          <img
            src={netflix}
            alt="web screenshot"
            className="max-h-80 border border-gray-100 rounded-xl shadow-lg mt-12 mb-10"
          />
          <div>
            <p className="text-2xl font-bold">Netflix Landing Page Clone</p>
            <p className="mt-5 font-semibold underline">
              Tools used for this Project:
            </p>
            <ul className="">
            ...
            <div className="mt-4 text-blue-800 font-bold text-center">
              ...
              <div className="mt-5">
                <a
                  ...
                  className="border-b-2 border-white text-2xl hover:border-blue-800"
                >
                  Live
                </a>
              </div>
      ...
      <section className="w-full h-full m-auto border-2 border-gray-100">
        <div className="flex items-center justify-evenly">
          ...
          />
          <div>
            <p className="text-2xl font-bold">.Destiny Gym Landing Page</p>
            <p className="mt-5 font-semibold underline">
              Tools used for this Project:
            </p>
            <p className="ml-4 mt-5">&#9733; Tailwind Starter Kit</p>
            <div className="mt-4 text-blue-800 font-bold text-center">
              <div>
                <a
                  target="_blank"
      ...
      <section className="w-full h-full m-auto border-2 border-gray-100">
        <div className="flex items-center justify-evenly">
          ...
          />
          <div>
            <p className="text-2xl font-bold">Breaking Bad App</p>
            <p className="mt-5 font-semibold underline">
              Tools used for this Project:
            </p>
            <ul>
              ...
              <li className="ml-4 mt-5">&#9733; Vannila css</li>
            </ul>
            <div className="mt-4 text-blue-800 font-bold text-center">
              <div>
                <a
      ...
      <section className="w-full h-full m-auto border-2 border-gray-100">
        <div className="flex items-center justify-evenly">
          ...
          />
          <div>
            <p className="text-2xl font-bold">Pixabay Photo Gallery</p>
            <p className="mt-5 font-semibold underline">
              Tools used for this Project:
            </p>
            <ul>
              ...
              <li className="ml-4 mt-3">&#9733; Tailwind css</li>
              <ul>
                <li className="ml-10">Utility classes</li>
              </ul>
            </ul>
      ...
      <section className="w-full h-full m-auto border-2 border-gray-100">
        <div className="flex items-center justify-evenly">
          ...
          />
          <div>
            <p className="text-2xl font-bold">Parallax Landing Page</p>
            <p className="mt-5 font-semibold underline">
              Tools used for this Project:
            </p>
            <ul>
              <li className="ml-4 mt-5">&#9733; Vanilla JavaScript</li>
              <li className="ml-4 mt-5">&#9733; Rellax.js</li>
            </ul>
            <div className="mt-4 text-blue-800 font-bold text-center">
              <div>
                <a
